...
RSpec.describe FuncaosController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all funcaos as @funcaos" do
      ...
      expect(assigns(:funcaos)).to eq([funcao])
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created funcao as @funcao" do
        post :create, {:funcao => valid_attributes}, valid_session
        expect(assigns(:funcao)).to be_a(Funcao)
        expect(assigns(:funcao)).to be_persisted
      end

      it "redirects to the created funcao" do
        post :create, {:funcao => valid_attributes}, valid_session
        expect(response).to redirect_to(Funcao.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved funcao as @funcao" do
        post :create, {:funcao => invalid_attributes}, valid_session
        expect(assigns(:funcao)).to be_a_new(Funcao)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested funcao" do
        funcao = Funcao.create! valid_attributes
        put :update, {:id => funcao.to_param, :funcao => new_attributes}, valid_session
        funcao.reload
      ...
      it "redirects to the funcao" do
        funcao = Funcao.create! valid_attributes
        put :update, {:id => funcao.to_param, :funcao => valid_attributes}, valid_session
        expect(response).to redirect_to(funcao)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the funcao as @funcao" do
        funcao = Funcao.create! valid_attributes
        put :update, {:id => funcao.to_param, :funcao => invalid_attributes}, valid_session
        expect(assigns(:funcao)).to eq(funcao)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the funcaos list" do
      funcao = Funcao.create! valid_attributes
      delete :destroy, {:id => funcao.to_param}, valid_session
      expect(response).to redirect_to(funcaos_url)
    end
  end
