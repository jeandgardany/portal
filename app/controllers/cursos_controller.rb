class CursosController < ApplicationController
  ...
  def destroy
    @curso.destroy
    respond_to do |format|
      format.html { redirect_to cursos_url, notice: 'O Curso foi apagado com sucesso.' }
  ...
  private
    ...
    def set_curso
     authorize @curso = Curso.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def curso_params
      params.require(:curso).permit(:nome, :codigo, :duracao, :tipo)
    end
end
