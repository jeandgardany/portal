...
ActiveRecord::Schema.define(version: 20160525031103) do
  ...
  create_table "alunos", force: :cascade do |t|
    ...
    t.string   "mensalidade",     limit: 255, default: "R$"
  ...
  add_index "alunos_turmas", ["aluno_id", "turma_id"], name: "index_alunos_turmas_on_aluno_id_and_turma_id", using: :btree
  add_index "alunos_turmas", ["turma_id", "aluno_id"], name: "index_alunos_turmas_on_turma_id_and_aluno_id", using: :btree
  ...
  create_table "funcionarios", force: :cascade do |t|
    ...
    t.string   "salario",       limit: 255, default: "R$"
